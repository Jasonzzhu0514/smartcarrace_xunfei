...
def main():
    ...
    # 模型名称和路径配置
    model_configs = [
        {"name_prefix": "fruit_board_", "path": f"/home/iflytek-car/.gazebo/models/{random.choice(fruit_board_folders)}/model.sdf"},
        {"name_prefix": "vage_board_", "path": f"/home/iflytek-car/.gazebo/models/{random.choice(vege_board_folders)}/model.sdf"},
        {"name_prefix": "dessert_board_", "path": f"/home/iflytek-car/.gazebo/models/{random.choice(dessert_board_folders)}/model.sdf"}
    ]
