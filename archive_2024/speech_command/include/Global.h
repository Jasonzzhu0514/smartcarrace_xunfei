...
string appid = "edf0eb6d";                                               // 仅用于在线AIUI，用户可修改，普通用户每天500次
string key = "63da4237dd7ccba597b1438bc9f69a8b";                         // AIUI引擎Appid对应的AppKey
string offline_appid = "appid = edf0eb6d";					 //仅用于离线命令词识别I，用户可修改.
